      ...
      <div className="relative w-[420px] bg-white h-full shadow-xl flex flex-col animate-in slide-in-from-right duration-250 border-l border-[#e8eaed]">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex-1 overflow-y-auto px-5 py-5 space-y-5">
          <section className="space-y-4">
            <p className="text-sm font-semibold text-[#9ca3af] uppercase tracking-widest">역할 정보</p>
            ...
            {/* 설명 */}
            <div className="space-y-1.5">
              <label className="text-sm font-medium text-[#374151]">설명</label>
              <textarea
          ...
          <section className="space-y-3">
            <p className="text-sm font-semibold text-[#9ca3af] uppercase tracking-widest">색상</p>
          ...
          {/* 관리자 역할 */}
          <section className="space-y-3">
            <p className="text-sm font-semibold text-[#9ca3af] uppercase tracking-widest">고급 설정</p>
            <button
              type="button"
              ...
              className={`w-full flex items-center justify-between px-3.5 py-3 rounded-lg border transition-all ${
                selectedRole
                  ...
                  : isSystem
                    ...
                    : "border-[#e2e4e9] hover:border-[#c4c9d4]"
              }`}
            >
              ...
              <div
                className={`w-9 h-5 rounded-full transition-colors relative flex-shrink-0 ${isSystem ? "bg-[#4361ee]" : "bg-[#e2e4e9]"}`}
              >
                <span
                  className={`absolute top-0.5 w-4 h-4 bg-white rounded-full shadow transition-transform ${isSystem ? "translate-x-4" : "translate-x-0.5"}`}
                />
              </div>
            </button>
          </section>
