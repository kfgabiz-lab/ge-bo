...
const DETAIL_PAGE_PATH = "/admin/main/hero/detail";
...
const SORT_EXPRTable1: Record<string, string> = { sort_order: "sort_order=''?default:sort_order" };
const EDIT_PAGE_RULES_Table1: { connType?: string; pageSlug?: string; passParam?: string; conditionParam?: string }[] =
  [
    {
      connType: "popup",
      pageSlug: "hero-detail",
      passParam: "",
      conditionParam: "",
    },
  ];
...
export default function GeneratedPage() {
  ...
  const { t } = useI18n();
  useEffect(() => {
    setPageTitle(t("common.label.hero"));
  }, [setPageTitle, t]);
  ...
  const dataSlugTable1 = "hero-data";
                          ...
                          >
                            ...
                            >
                              {(() => {
                                const value = !Array.isArray(row["sort_order"])
                                  ? resolveEvalExprI18n(evalColumnDataExpr("sort_order=''?default:sort_order", row), t)
                                  : row["sort_order"];
                            ...
                            >
                              {(() => {
                                ...
                                const afterLabel = t("common.status.after");
