...
export default function QuickListBuilderPage() {
  ...
  const buildWidgetItems = () => {
    ...
    const normalized = normalizeFormItemRowSpans(
      12,
      searchContent.rowSpan + spaceContent.rowSpan + tableContent.rowSpan,
      rawContents
    );
    return [
      {
                  ...
                  <div className="border-t border-slate-100 bg-slate-50/50">
                    ...
                    <div className="px-3 pb-2 pt-1">
                      <CommonBuilderDispatcher
                        widget={searchContent.widget}
                        onChange={(w) =>
                          setSearchContent((prev) => ({ ...prev, widget: w as typeof searchContent.widget }))
                        }
                  ...
                  <div className="border-t border-slate-100 bg-slate-50/50">
                    ...
                    <div className="px-3 pb-2 pt-1">
                      <CommonBuilderDispatcher
                        widget={spaceContent.widget}
                        onChange={(w) =>
                          setSpaceContent((prev) => ({ ...prev, widget: w as typeof spaceContent.widget }))
                        }
                  ...
                  <div className="border-t border-slate-100 bg-slate-50/50">
                    ...
                    <div className="px-3 pb-2 pt-1">
                      <CommonBuilderDispatcher
                        widget={tableContent.widget}
                        onChange={(w) =>
                          setTableContent((prev) => ({ ...prev, widget: w as typeof tableContent.widget }))
                        }
                        context={{
                          slugOptions,
                          pageTemplates,
