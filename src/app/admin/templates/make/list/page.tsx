...
export default function MakeListPage() {
  ...
  const listTypeTemplates = templateList.filter(
    (t) =>
      t.templateType === "LIST" &&
  ...
  return (
    <div className="space-y-5">
        ...
        {panelOpen && (
          <div className="bg-white border border-slate-200 rounded-xl sticky top-4">
            ...
            <div className="px-3 py-2 border-b border-slate-100 bg-slate-50/50 flex items-center justify-between">
              <div className="flex items-center gap-1 bg-slate-100 p-0.5 rounded-md">
                ...
                >
                  ...
                  테이블 <span className="text-slate-400 font-normal">{tableWidget.columns.length}</span>
                </button>
                <button
                  onClick={() => {
                    setActiveTab("button");
            ...
            <div className="p-3 space-y-2 max-h-[calc(100vh-280px)] overflow-y-auto">
              {activeTab === "search" && <SearchBuilder rows={fieldRows} onChange={setFieldRows} />}
            ...
            <div className="bg-slate-50 border border-slate-200 rounded-xl p-6 min-h-[500px] space-y-4">
              ...
              {tableWidget.columns.length === 0 ? (
                ...
                <div className="bg-white border border-slate-200 rounded-xl overflow-x-auto">
                  <table
                    style={{
                      width: tableWidget.columns.some((c) => c.widthUnit === "%")
                        ? `${tableWidget.columns.reduce((sum, c) => sum + (c.widthUnit === "%" ? c.width || 0 : 0), 0)}%`
                        : undefined,
                      minWidth:
                        tableWidget.columns.reduce((sum, c) => sum + (c.widthUnit === "%" ? 0 : c.width || 150), 0) ||
                        "100%",
                    }}
                  >
                    <thead>
      ...
      <WidgetRenderer mode="live" widget={null} externalPopupTrigger={previewPopupTrigger} />
    </div>
  );
}
