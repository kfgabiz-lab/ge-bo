...
export default function QuickDetailBuilderPage() {
  ...
  useEffect(() => {
    if (om.outputMode === "layerpopup" && om.layerType === "right") {
      ...
      setSpaceContent((prev) => ({
        ...
        widget: {
          ...prev.widget,
          items: (prev.widget as SpaceWidget).items.map((i) => ({
            ...i,
  ...
  const buildWidgetItems = () => {
    const rawContents = [
      { id: formContent.id, colSpan: formContent.colSpan, rowSpan: formContent.rowSpan, widget: formContent.widget },
      {
        id: spaceContent.id,
    ...
    const normalized = normalizeFormItemRowSpans(12, formContent.rowSpan + spaceContent.rowSpan, rawContents);
    return [
      {
        id: "wi-all",
        colSpan: 12,
        rowSpan: normalized.rowSpan,
        contents: normalized.contents.map((c) => ({ ...c, widget: c.widget as unknown as Record<string, unknown> })),
      },
    ];
  };
    ...
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-[340px_1fr] gap-5 items-start">
            ...
            <div className="border border-slate-200 rounded-lg overflow-hidden">
              ...
              <div className="flex items-center gap-1.5 px-2 py-1.5 bg-slate-900 select-none">
                ...
                <span className="text-[10px] font-semibold flex-1 truncate text-slate-300">
                  위젯 1<span className="ml-1 font-normal text-[9px] text-slate-500">고정 구조</span>
                </span>
        ...
        <div className="space-y-4">
          ...
          <div
            className={`bg-slate-100 rounded-xl min-h-[500px] overflow-hidden flex flex-col ${om.outputMode !== "layerpopup" ? "p-6" : ""}`}
          >
            <PreviewWrapper
              outputMode={om.outputMode}
              layerType={om.layerType}
                ...
                >
                  <div
                    style={{
                      ...
                      minHeight: `${formContent.rowSpan * ROW_HEIGHT}px`,
                    }}
                  ...
                  <div
                    style={{
                      ...
                      minHeight: `${spaceContent.rowSpan * ROW_HEIGHT}px`,
                    }}
                  >
      ...
      <SaveModal
        ...
        onConfirm={() =>
          tm.handleSaveConfirm(buildWidgetItems(), {
            outputMode: om.outputMode,
            pageTitle: om.pageTitle,
            layerType: om.layerType,
            layerTitle: om.layerTitle,
