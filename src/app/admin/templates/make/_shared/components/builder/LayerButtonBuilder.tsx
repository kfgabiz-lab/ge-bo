    ...
    <div className="space-y-2">
      ...
      {buttons.map((btn, idx) => (
        <div key={btn.id} className="border border-slate-200 rounded-lg p-3 space-y-2 bg-white">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-0.5">
              ...
              <button
                ...
                className="p-1 rounded text-slate-400 hover:bg-red-50 hover:text-red-500 transition-all"
              >
          ...
          {/* 레이블 */}
          <div>
            <label className="text-sm font-semibold text-slate-500 mb-0.5 block">버튼 레이블</label>
            <input
              value={btn.label}
          ...
          {/* 스타일 */}
          <div>
            <label className="text-sm font-semibold text-slate-500 mb-0.5 block">스타일</label>
          ...
          {/* 액션 */}
          <div>
            <label className="text-sm font-semibold text-slate-500 mb-0.5 block">액션</label>
            <div className="relative">
              <select
                value={btn.action}
