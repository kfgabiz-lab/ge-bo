...
export function DateField({
  ...
  /* 서브타입별 input type */
  const inputType =
    subType === "yearMonth" ? "month" : subType === "datetime" ? "datetime-local" : isTimeBased ? "time" : "date";
  ...
  return (
    <div className="space-y-1.5">
      ...
      <DataGenerationSection values={values} onChange={onChange} fieldType="date" />
    </div>
  );
}
