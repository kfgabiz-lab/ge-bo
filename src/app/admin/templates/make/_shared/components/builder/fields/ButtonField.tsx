...
export function ButtonField({ values, onChange, colSpanMode, rowSpanConfig, codeGroups, codeGroupsLoading, autoFocus, onLabelKeyDown, slugEntityFields }: FieldEditProps) {
    return (
