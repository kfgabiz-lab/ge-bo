...
export const FieldPickerTypeList = ({ types, onSelect, onCancel }: FieldPickerTypeListProps) => (
  <>
    ...
    <div className="flex items-center justify-between px-2 pb-1">
      <span className="text-sm font-semibold text-slate-500 uppercase">필드 유형 선택</span>
    ...
    {types.map((ft) => (
      ...
      >
        ...
        {ft.defaultColSpan !== undefined && <span className="text-[10px] text-slate-400">×{ft.defaultColSpan}</span>}
      </button>
    ))}
  </>
);
