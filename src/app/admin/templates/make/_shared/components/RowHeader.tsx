  ...
  return (
    ...
    >
      <div className="flex items-center gap-2">
        ...
        {dragHandleProps && (
          <span
            ...
            {...(dragHandleRest as React.HTMLAttributes<HTMLSpanElement>)}
        ...
        {onToggleCollapse && (
          <ChevronDown className={`w-3 h-3 text-slate-400 transition-transform ${collapsed ? "-rotate-90" : ""}`} />
        )}
        <span className="text-sm font-semibold text-slate-500">Row {rowIdx + 1}</span>
        {/* 열 수 선택 탭 (1~5) */}
      ...
      <div className="flex items-center gap-0.5" onClick={(e) => e.stopPropagation()}>
        ...
        <button onClick={onRemove} className="p-1 rounded text-slate-400 hover:bg-red-50 hover:text-red-500">
